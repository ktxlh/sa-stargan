...
class Solver(object):
    ...
    def build_model(self):
        ...
        if self.dataset in ['CelebA', 'RaFD']:
            self.G = Generator(self.batch_size,self.image_size, self.c_dim, self.g_conv_dim).cuda()
            self.D = Discriminator(self.batch_size,self.image_size, self.c_dim, self.d_conv_dim).cuda()
